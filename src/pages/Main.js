...
const Main = () => {
    ...
    return (
        <div className="bg-secondary w-full h-full flex flex-col">
            <header class="text-gray-600 body-font shadow bg-white">
                <div class="container mx-auto flex flex-wrap justify-between p-5 flex-col md:flex-row items-center">
                    ...
                    <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded textprimary mt-4 md:mt-0">
                        Logout
                    </button>
                </div>
            </header>
